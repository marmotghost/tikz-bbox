...
%
% The actions by someone who had nothing better to do than to step on others
% by commenting on GitHub messages that were not at all her concern in public chats 
% have caused so much bad blood that this library is not part of pgf.
% As a consequence, a patch that does away with most of the dimension too large errors
% will presumably never get completed. However, many of the dimension too
% large errors (not related to this library!) can be cured by using the
% use fpu reciprocal key, which is described at the end of this short manual.
